...
export default {
  ...
  pacto: {
    ...
    ayuda4: 'Abajo del todo están tus logros: se consiguen una vez y <b>no se pierden nunca</b>, aunque falles después.',
  ...
  progreso: {
    ...
    llegas: 'Llegas a {kg} kg en',
    meses: 'meses · {n} semanas',
    yaEnMeta: '¡Ya estás en tu meta! 🎉',
    siguiendoRitmo: 'Aún no hay fecha: sigue apuntando, y en cuanto el ritmo apunte a tu meta, aparece aquí.',
  ...
  lore: {
    ...
    actos: [
      { t: 'Las calles de Bangkok',
        d: 'Ninja era un gato callejero. Malvivía rebuscando comida en la basura.' },
      { t: 'Anna, la enfermera',
        d: 'Cada noche, al salir del trabajo, les dejaba algo de comer a él y a sus hermanos. Se conocían desde hacía meses, pero Ninja nunca se acercaba a ningún humano.' },
      { t: 'El peligro',
        d: 'No a todo el mundo le gustan los gatos callejeros, y algunos son capaces de llegar muy lejos. Una noche Ninja solo vio una silueta con una escoba en alto.' },
      { t: '¡Escapó por los pelos!',
        d: 'Esquivó el escobazo y salió corriendo. En aquel sitio ya no era bienvenido.' },
      { t: 'Las noches con hambre',
        d: 'Se quedó escondido una temporada. Cada día que pasaba tenía más hambre.' },
      { t: 'El amanecer',
        d: 'Un día decidió salir otra vez a buscar comida.' },
      { t: 'La trampa',
        d: 'Encontró un bol lleno de comida. Estaba limpio y reluciente. Ninja no sospechó nada en absoluto.' },
      { t: 'El atracón',
        d: 'Se lo comió todo. Hacía mucho que no llenaba la barriga.' },
      { t: 'La noche',
        d: 'La comida estaba envenenada. Cayó bajo la lluvia, en mitad de la calle, sin poderse levantar.' },
      { t: 'La carrera al veterinario',
        d: 'Anna fue a darle de comer, como cada noche, y lo encontró tirado en el suelo. Lo cogió en brazos y corrió al veterinario bajo la lluvia.' },
      { t: 'El veterinario',
      ...
      { t: 'En casa',
        d: 'Ninja ya no vive en la calle. Ahora tiene una familia que lo quiere, y nunca más tendrá que rebuscar en la basura.' },
    ],
  },
