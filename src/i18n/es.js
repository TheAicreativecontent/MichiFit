...
export default {
  ...
  lore: {
    ...
    actos: [
      { t: 'El callejón',
        d: 'Ninja vivía en un callejón de Bangkok. Comía lo que encontraba, y casi nunca encontraba.' },
      { t: 'La enfermera',
        d: 'Una enfermera le dejaba algo al salir del turno. Llevaban meses así: ella lo dejaba, él esperaba a que se fuera.' },
      { t: 'El peligro',
        d: 'Una noche alguien lo echó. Ninja solo vio una sombra enorme y una escoba en alto.' },
      { t: 'La huida',
        d: 'Escapó por los pelos. El escobazo dio en el suelo.' },
      { t: 'El hambre',
        d: 'Se escondió detrás de unas cajas, con la tripa vacía y sonándole.' },
      { t: 'El amanecer',
        d: 'Amaneció. Bangkok se puso dorada y Ninja salió otra vez a buscarse la vida.' },
      { t: 'La trampa',
        d: 'Encontró un bol lleno. Demasiado limpio, demasiado bonito para estar en esa calle.' },
      { t: 'El banquete',
        d: 'Comió feliz. Era la primera vez que se llenaba.' },
      { t: 'La noche',
        d: 'Estaba envenenado. Cayó bajo la lluvia, en mitad de la calle, y no podía levantarse.' },
      { t: 'La carrera',
        d: 'Ella lo encontró esa noche. Corrió con él en brazos hasta el veterinario, empapada.' },
      { t: 'El rescate',
        d: 'Le salvaron la vida. Cuando abrió los ojos, ella seguía allí, dormida en la silla.' },
      { t: 'Casa',
