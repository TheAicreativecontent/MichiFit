...
export default {
  ...
  lore: {
    ...
    actos: [
      { t: '小巷',
        d: '忍者住在曼谷的一条小巷里。找到什么就吃什么，而它几乎什么都找不到。' },
      { t: '护士',
        d: '有位护士下班后总会留一点吃的给它。这样过了好几个月：她放下，它等她走远。' },
      { t: '危险',
        d: '一天夜里有人赶它走。忍者只看见一个巨大的影子和高高举起的扫帚。' },
      { t: '逃脱',
        d: '它险险逃掉了。扫帚打在了地上。' },
      { t: '饥饿',
        d: '它躲在几个箱子后面，肚子空空，咕咕直叫。' },
      { t: '天亮了',
        d: '天亮了。曼谷变成金色，忍者又出门找吃的。' },
      { t: '陷阱',
        d: '它找到一碗满满的食物。太干净了，太漂亮了，不该出现在那条街上。' },
      { t: '饱餐',
        d: '它吃得很开心。那是它第一次吃饱。' },
      { t: '那一夜',
        d: '它中毒了。它倒在雨中的马路中央，站不起来。' },
      { t: '雨中奔跑',
        d: '那晚她找到了它。她浑身湿透，抱着它一路跑到兽医那里。' },
      { t: '获救',
        d: '它活下来了。睁开眼睛时，她还在那里，睡在椅子上。' },
      { t: '家',
        d: '忍者不再住在街上了。现在轮到你了：照顾好自己，它就会很好。' },
    ],
  },
